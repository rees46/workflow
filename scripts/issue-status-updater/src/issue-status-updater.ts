...
type UpdateIssueStatus = (projectId: string, projectIssueId: string, fieldId: string, optionId: string) => Promise<void>

export const updateIssueStatus: UpdateIssueStatus = async (projectId, issueId, fieldId, optionId) => {
